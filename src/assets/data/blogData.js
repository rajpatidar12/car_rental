...
const blogData = [
...

  {
    ...
    imgUrl: img02,
    description:
      "A car or automobile is a motor vehicle with wheels. Most definitions of cars say that they run primarily on roads, seat one to eight people, have four wheels, and mainly transport people (rather than goods). Cars were invented in 1886, when German inventor Carl Benz patented his Benz Patent-Motorwagen.Plan for stops. It is reasonable to estimate that you will need to take a break from travelling every two or three hours. If there is an interesting city, park, store, or restaurant that you would like to see on your road trip, schedule stops accordingly. It is all part of the road trip experience.",
    quote:
